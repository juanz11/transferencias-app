...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Registrar Charla - Admin</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.charlas.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <select id="visitador_id" class="form-control @error('visitador_id') is-invalid @enderror" name="visitador_id">
                                    ...
                                    @foreach($visitadores as $visitador)
                                        <option value="{{ $visitador->id }}" {{ old('visitador_id') == $visitador->id ? 'selected' : '' }}>{{ $visitador->nombre }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                <select id="cliente_id" class="form-control @error('cliente_id') is-invalid @enderror" name="cliente_id" required>
                                    ...
                                    @foreach($clientes as $cliente)
                                        <option value="{{ $cliente->id }}" data-zona="{{ $cliente->zona ?? '' }}" {{ old('cliente_id') == $cliente->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="zona" type="text" class="form-control @error('zona') is-invalid @enderror" name="zona" value="{{ old('zona') }}" readonly>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cantidad_charlas" type="number" min="0" class="form-control @error('cantidad_charlas') is-invalid @enderror" name="cantidad_charlas" value="{{ old('cantidad_charlas') }}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="participantes" type="number" min="0" class="form-control @error('participantes') is-invalid @enderror" name="participantes" value="{{ old('participantes') }}" required>
